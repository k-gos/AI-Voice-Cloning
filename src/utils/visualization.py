...
def plot_speaker_embeddings(
    ...
    Args:
        embeddings: Speaker embeddings tensor
    ...
    for i, speaker_id in enumerate(speaker_ids):
        plt.annotate(speaker_id, (embeddings_2d[i, 0], embeddings_2d[i, 1]))
